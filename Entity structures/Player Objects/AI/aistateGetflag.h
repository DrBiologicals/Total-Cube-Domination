...
#ifndef __IGFEB10_MODULE_AISTATEGETFLAG_H__
#define __IGFEB10_MODULE_AISTATEGETFLAG_H__
...
class CAIStateGetFlag : public CAIState
{
	// Member Functions
public:
	CAIStateGetFlag();
	virtual ~CAIStateGetFlag();
...
#endif // __IGFEB10_MODULE_AISTATEGETFLAG_H__
